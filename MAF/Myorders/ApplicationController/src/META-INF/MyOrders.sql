...
(
      ...
      DUE_DATE VARCHAR ,
      INVOICE_TOTAL_AMOUNT VARCHAR  NOT NULL,
      INVOICE_DUE_AMOUNT VARCHAR  NOT NULL,
      ALERT_FLAG VARCHAR ,
    CONSTRAINT TRANSACTION_ACTIVITIES_PK PRIMARY KEY(CUSTOMER_TRX_ID,INVOICE_TOTAL_AMOUNT,INVOICE_DUE_AMOUNT)
);
...
(
      ...
      INVOICE_DUE_AMOUNT VARCHAR  NOT NULL,
      ALERT_FLAG VARCHAR ,
    CONSTRAINT ALL_TRANSACTION_ACTIVITIES_PK PRIMARY KEY(CUSTOMER_TRX_ID,INVOICE_TOTAL_AMOUNT,INVOICE_DUE_AMOUNT)
);
