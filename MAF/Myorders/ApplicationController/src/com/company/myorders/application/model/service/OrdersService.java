...
import com.company.myorders.application.model.Orders;
...
public class OrdersService extends EntityCRUDService<Orders> {
    ...
    public List<Orders> getOrders() {
        if(AdfmfJavaUtilities.getELValue("#{pageFlowScope.isFilterApplier}")=="Y"){
            ...
            String item = (String) AdfmfJavaUtilities.getELValue("#{pageFlowScope.fOrderValue}");
            String po = (String) AdfmfJavaUtilities.getELValue("#{pageFlowScope.fPO}");
            String status = (String) AdfmfJavaUtilities.getELValue("#{pageFlowScope.fStatus}");
            String alert = (String) AdfmfJavaUtilities.getELValue("#{pageFlowScope.fAlert}");
            if(orderNo!=null){
