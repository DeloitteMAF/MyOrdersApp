...
public interface XxMyOrdersService {
    ...
    List<XxMyLocationsVOSDO> getCustomerLocations(@WebParam(mode = WebParam.Mode.IN, name = "custAccountId")
    ...
    @WebResult(name = "result")
    List<XxMyOrdersVOSDO> getRequestedOrders(@WebParam(mode = WebParam.Mode.IN, name = "custAccountId")
                                             Long custAccountId,
