...
public interface XxMyOrdersService {
    ...
    /**
     * Exported method pushNotifications from XxMyOrdersAM.
     */
    @WebMethod(action = "/xx/orders/am/common/pushNotifications", operationName = "pushNotifications")
    @RequestWrapper(targetNamespace = "/xx/orders/am/common/types/", localName = "pushNotifications")
    @ResponseWrapper(targetNamespace = "/xx/orders/am/common/types/", localName = "pushNotificationsResponse")
    @WebResult(name = "result")
    String pushNotifications() throws ServiceException;

    /**
     * Exported method startPollingJob from XxMyOrdersAM.
     */
    @WebMethod(action = "/xx/orders/am/common/startPollingJob", operationName = "startPollingJob")
    @RequestWrapper(targetNamespace = "/xx/orders/am/common/types/", localName = "startPollingJob")
    @ResponseWrapper(targetNamespace = "/xx/orders/am/common/types/", localName = "startPollingJobResponse")
    void startPollingJob() throws ServiceException;

    /**
     * Exported method getARForUser from XxMyOrdersAM.
     */
    @WebMethod(action = "/xx/orders/am/common/getARForUser", operationName = "getARForUser")
    @RequestWrapper(targetNamespace = "/xx/orders/am/common/types/", localName = "getARForUser")
    @ResponseWrapper(targetNamespace = "/xx/orders/am/common/types/", localName = "getARForUserResponse")
    @WebResult(name = "result")
    List<XxMyOrderARHeaderVOSDO> getARForUser(@WebParam(mode = WebParam.Mode.IN, name = "orderNumber")
                                              String orderNumber,
                                              @WebParam(mode = WebParam.Mode.IN, name = "noOfDays") Integer noOfDays,
                                              @WebParam(mode = WebParam.Mode.IN, name = "noOfRows") Integer noOfRows,
                                              @WebParam(mode = WebParam.Mode.IN, name = "userName") String userName,
                                              @WebParam(mode = WebParam.Mode.IN, name = "orderBy") String orderBy,
                                              @WebParam(mode = WebParam.Mode.IN, name = "fetchClosedOrders")
